...
from qfluentwidgets import (  # type: ignore
    ...
    CheckBox, SpinBox, ProgressBar, FluentIcon, InfoBarPosition, InfoBar
)
...
class WebScrapingTab(QWidget):
    ...
    def _create_ui(self):
        ...
        # 说明文本
        hint_label = BodyLabel("从网页中抓取媒体URL:")  # type: ignore
        layout.addWidget(hint_label)

        # 网页URL输入卡片
        self.url_card = CardWidget(self)  # type: ignore
        ...
        self.web_url_input = LineEdit()  # type: ignore
        ...
        # 抓取按钮
        self.fetch_button = PushButton("抓取URL")  # type: ignore
        self.fetch_button.setIcon(FluentIcon.GLOBE)  # type: ignore
        ...
        # 标题
        options_title = StrongBodyLabel("抓取选项")  # type: ignore
    ...
    def _fetch_urls_from_web(self):
        ...
        # 显示进度条
        progress = ProgressBar(self)  # type: ignore
