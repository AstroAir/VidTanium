...
class TaskOptionsWidget(QWidget):
    ...
    def _create_ui(self):
        ...
        self.priority_combo.addItem("高", userData="high")
        self.priority_combo.addItem("中", userData="normal")
        self.priority_combo.addItem("低", userData="low")
    ...
    def get_notify(self) -> bool:
        """是否需要通知"""
        return bool(self.notify_check.isChecked())
