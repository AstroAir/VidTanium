...
class LogToolbar(QToolBar):
    ...
    def _create_ui(self):
        ...
        # Clear logs
        self.clear_action = QAction(FluentIcon.DELETE.icon(), "Clear Logs", self)
        self.clear_action.setToolTip("Clear all current logs")
        self.clear_action.triggered.connect(self.clearRequested.emit)
        self.addAction(self.clear_action)

        # Save logs
        self.save_action = QAction(FluentIcon.SAVE.icon(), "Save Logs", self)
        ...
        # Copy selected
        self.copy_action = QAction(FluentIcon.COPY.icon(), "Copy", self)
        ...
        # Select all
        self.select_all_action = QAction(FluentIcon.ACCEPT.icon(), "Select All", self)
        ...
        # Show details
        self.detail_action = QAction(FluentIcon.INFO.icon(), "Show Details", self)
        ...
        self.export_html_action = QAction(
            FluentIcon.DOCUMENT.icon(), "Export as HTML", self)
        ...
        # Auto clean setting
        self.auto_clean_action = QAction(FluentIcon.BRUSH.icon(), "Auto Clean", self)
        ...
        # Font zoom in/out
        self.zoom_in_action = QAction(FluentIcon.ZOOM_IN.icon(), "Zoom In", self)
        self.zoom_in_action.setToolTip("Increase font size")
        self.zoom_in_action.triggered.connect(self.zoomInRequested.emit)
        self.addAction(self.zoom_in_action)

        self.zoom_out_action = QAction(FluentIcon.ZOOM_OUT.icon(), "Zoom Out", self)
