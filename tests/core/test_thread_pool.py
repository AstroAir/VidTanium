...
class TestWorker:
    ...
    def test_worker_initialization_with_progress_callback(self):
    ...
    def test_worker_run_with_args_and_kwargs(self):
...
class TestThreadPoolManager:
    ...
    def test_initialization_with_max_threads(self):
    ...
    @patch('os.cpu_count')
    def test_initialization_default_threads(self, mock_cpu_count):
    ...
    @patch('os.cpu_count')
    def test_initialization_cpu_count_none(self, mock_cpu_count):
    ...
    def test_submit_task_with_callbacks(self):
    ...
    def test_submit_task_with_args_kwargs(self):
        ...
        def parameterized_task(a, b, c=None):
            return f"{a}-{b}-{c}"
    ...
    def test_submit_task_callback_execution(self):
    ...
    def test_submit_task_error_callback_execution(self):
...
class TestGlobalFunctions:
    ...
    def test_submit_task_global_function(self):
    ...
    def test_submit_task_global_with_callbacks(self):
    ...
    def test_submit_task_global_with_args(self):
