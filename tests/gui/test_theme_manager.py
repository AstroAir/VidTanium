...
class TestEnhancedThemeManager:
    ...
    def test_set_theme_system(self, mock_listener, mock_set_theme):
    ...
    @patch('src.gui.theme_manager.setTheme')
    def test_set_theme_light(self, mock_set_theme):
    ...
    @patch('src.gui.theme_manager.setTheme')
    def test_set_theme_dark(self, mock_set_theme):
    ...
    def test_set_theme_with_animation(self):
    ...
    def test_set_theme_signal_emission(self):
    ...
    def test_set_accent_color_signal_emission(self):
    ...
    def test_get_current_accent(self):
    ...
    def test_is_dark_theme(self, mock_is_dark):
    ...
    def test_apply_accent_from_settings(self):
    ...
    def test_apply_widget_enhancement(self):
    ...
    def test_error_handling_in_set_theme(self):
    ...
    def test_cleanup_theme_listener(self):
    ...
    def test_animation_transition_without_parent(self):
    ...
    def test_custom_styling_application(self):
    ...
    def test_accent_color_persistence(self):
